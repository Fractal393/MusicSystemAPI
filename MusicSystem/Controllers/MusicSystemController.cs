...
namespace MusicSystem.Controllers
{
    public class MusicSystemController : ControllerBase
    {
        ...
        public MusicSystemController(AlbumService albumService, SongByNameService songByNameService, PlaylistService playlistService, PreviousPurchasesService previousPurchasesService, FilterService filterService)
        {
